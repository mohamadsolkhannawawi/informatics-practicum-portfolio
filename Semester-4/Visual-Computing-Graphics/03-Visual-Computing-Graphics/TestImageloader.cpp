...
// Konstruktor dan destruktor kelas Image
...
// Konversi 2 byte ke integer (little-endian)
short toShort(const char* bytes) {
    return (short)(((unsigned char)bytes[1] << 8) |
                   (unsigned char)bytes[0]);
}

// Membaca 4 byte sebagai integer (little-endian)
...
// Membaca 2 byte sebagai short (little-endian)
...
// Template class untuk menangani alokasi memori otomatis
template<class T>
class auto_array {
private:
    T* array;
...
// Fungsi untuk memuat gambar BMP
